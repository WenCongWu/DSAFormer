...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./weights/DSAFormer_FLIR.pt', help='model.pt path(s)')
    ...
    p = "/home/F/wwc/PythonProjects/IDSFormer/dataset/FLIR-align-3class/labels/test"
