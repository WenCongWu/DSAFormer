...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_DSAFormer_FLIR.yaml', help='model.yaml path')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        # 2024/10/27 wwc 修改
        #ckpt = opt.resume if isinstance(opt.resume, str) else get_latest_run('/home/F/wwc/PythonProjects/IDSFormer/runs/train/exp')  # specified or most recent path
